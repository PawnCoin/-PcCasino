...
const games: GameCard[] = [
  ...
  },
  {
    id: 'blackjack',
    name: 'Blackjack',
    description: 'Beat the dealer to 21. Split hands, Double Down, Insurance — professional card art.',
  ...
  },
  {
    id: 'roulette',
    name: 'Roulette',
    description: 'French Roulette with La Partage & En Prison rules. Live croupier voiceover EN/FR/RU.',
  ...
  },
  {
    id: 'craps',
    name: 'Craps & Dice',
    description: 'Full casino craps with 3D graphics, pass/don\'t pass, odds bets, and hardways.',
  ...
  },
  {
    id: 'horse-racing',
    name: 'Horse Racing',
    description: 'Bet on live horse races with full odds board, multiple horses, and $Pc chip denominations.',
    image: '/logos/game-horse-racing.png',
    minBet: 1000,
    activeTables: 0,
    badge: 'NEW',
    href: '/game/horse-racing',
  },
  {
    id: 'pool',
    name: 'Pool Table',
    description: '8-Ball pool on a premium felt table. Play against friends or AI in tournament mode.',
  ...
  },
  {
    id: 'darts',
    name: 'Darts',
    description: '501, Cricket, and Around the World. Challenge opponents and wager $Pc on every throw.',
  ...
  },
  {
    ...
    image: '/images/weparlay-menu.png',
    minBet: 10,
    activeTables: 0,
    badge: 'SPORTS',
    href: 'https://weparlay.io',
    isExternal: true,
    externalUrl: 'https://weparlay.io',
    isSpecial: 'sports',
  },
  {
    id: 'vip',
    ...
    image: '/images/adult-menu-banner.png',
    minBet: 500,
    activeTables: 7,
    badge: 'VIP',
    href: '/vip',
